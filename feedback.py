...
class fb:
    def __init__(self):
        ...
        ###########Images######
        global photo
        photo=PhotoImage(file= "IHM\esiee.gif")
        Label(root, image= photo).place(x= 40, y= 500)


        photo2=PhotoImage(file= "IHM\s_feedb.gif")
        photo2= photo2.subsample(3)
        Label(root, image= photo2).place(x= 700, y= 500)
        #######################
