...
##########################################
        ...
        outils.grid(row=0, column=0, pady=50)
        ...
        apps=ttk.Combobox(mainframe, textvariable= ordre,
                        ...
                        stat='readonly')
        apps.grid(row=0, column=1, columnspan=2, sticky=(W, E), pady=50)


        com=ttk.Button(mainframe, text="FeedBack", command=lambda : Launch("Feedback"))
        com.grid(row=8, column=0, sticky='w', pady=50)
        
        
        
        
        exe=ttk.Button(mainframe, text="Allons-y", command=lambda : Launch(ordre.get()))
        exe.grid(row=0, column=5, sticky='nsew', pady=50)
